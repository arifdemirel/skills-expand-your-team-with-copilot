document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleShare(button) {
    ...
    if (button.classList.contains('twitter-share')) {
      ...
      const emailSubject = encodeURIComponent(`${activityName} at Mergington High School`);
